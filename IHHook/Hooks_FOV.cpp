...
namespace IHHook
{
    namespace Hooks_FOV
    {
        ...
        void __fastcall UpdateCameraHook(const uintptr_t thisptr)
        {
            ...
            *target_focalLength = *target_focalLength == default_tpp_fov        ? new_tpp_fov
        ...
        void CreateHooks()
        {
            ...
            // eg update 1.14
            // tex unless konami goes crazy and reenables encryption (in that case refer to the original fov hook), just
            // assuming it will stay off.
            ...
            // tex since updateFOVLerpRef is at the address part of of the E8 CALL rel32 (see REF above again), it needs to jump
            // to the next instruction (+4) then add the dereferenced rel32 UpdateFOVLerpAddr =
