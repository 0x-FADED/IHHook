...
std::string VehicleFpksDefault[]{
    "/Assets/tpp/pack/vehicle/veh_rl_west_lv.fpk", "/Assets/tpp/pack/vehicle/veh_rl_east_lv.fpk", "/Assets/tpp/pack/vehicle/veh_rl_west_trc.fpk", "/Assets/tpp/pack/vehicle/veh_rl_east_trc.fpk", "/Assets/tpp/pack/vehicle/veh_rl_west_wav_machinegun.fpk", "/Assets/tpp/pack/vehicle/veh_rl_west_wav_cannon.fpk", "/Assets/tpp/pack/vehicle/veh_rl_east_wav.fpk", "/Assets/tpp/pack/vehicle/veh_rl_east_wav_rocket.fpk", "/Assets/tpp/pack/vehicle/veh_rl_west_tnk.fpk", "/Assets/tpp/pack/vehicle/veh_rl_east_tnk.fpk",
};

/*
        Vehicle hooks
*/
u64 GetVehiclePartsFpk(u32 vehicleType)
{
    ...
    case 9:
        ...
        break;
    default:
        return 0; // ZIP: vehicleType is outside range, return 0. Can happen
                  // with helicopter in sortie.
        break;
    }
...
// ZIP: Function that loads the player vehicle and the selected camo for
// deployment.
char PreparePlayerVehicleInGameHook(i64 param_1, u64 param_2)
{
    ...
    u64 lVar2 = *(i64*) (param_1 + 0x58);
    char vehicleType = *(byte*) (lVar2 + 0x2b);
    u64 newVehicleFpk = GetVehiclePartsFpk(vehicleType - 1);
    if (newVehicleFpk == 0)
    {
...
// ZIP: Function that loads the player vehicle and all the camos applicable in
// sortie.
char PreparePlayerVehicleInSortieHook(i64 param_1)
{
    ...
    void* loadPtrFunc = (void*) LoadDefaultFpkPtrFunc(*(i64*) (param_1 + 0x50), 0);

    // ZIP: Loads all camos for the player to choose from.
    u64* camoDatFpkArray = LoadAllVehicleCamoFpks();
    u64 numOfCamos;
    i64 maxCamoLength = 0x5f; // 95
    u64 camoIt = (u64) (vehicleType != 0);
    do
    {
    ...
    int outArray[4];
    LoadDefaultFpksFunc(loadPtrFunc, outArray, fileIndex, (u32)numOfCamos);
