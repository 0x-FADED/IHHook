    ...
    namespace Hooks_Buddy
    {
        ...
        */
        std::string buddyHorsePartsFpksDefault[]{
            "/Assets/tpp/pack/buddy/horse/buddy_horse2_00.fpk",   "/Assets/tpp/pack/buddy/horse/buddy_horse2_03.fpk",
            "/Assets/tpp/pack/buddy/horse/buddy_horse2_02_0.fpk", "/Assets/tpp/pack/buddy/horse/buddy_horse2_02_1.fpk",
            "/Assets/tpp/pack/buddy/horse/buddy_horse2_02_2.fpk", "/Assets/tpp/pack/buddy/horse/buddy_horse2_05.fpk",
            "/Assets/tpp/pack/buddy/horse/buddy_horse2_04.fpk",
        };
        std::string buddyDogPartsFpksDefault[]{
            "/Assets/tpp/pack/buddy/dog/buddy_dog2_00.fpk", "/Assets/tpp/pack/buddy/dog/buddy_dog2_01.fpk", "/Assets/tpp/pack/buddy/dog/buddy_dog2_02.fpk",
            "/Assets/tpp/pack/buddy/dog/buddy_dog2_03.fpk", "/Assets/tpp/pack/buddy/dog/buddy_dog2_04.fpk",
        };
        std::string buddyQuietPartsFpksDefault[]{
            "/Assets/tpp/pack/buddy/quiet/buddy_quiet2_00.fpk", "/Assets/tpp/pack/buddy/quiet/buddy_quiet2_01.fpk",
            "/Assets/tpp/pack/buddy/quiet/buddy_quiet2_02.fpk", "/Assets/tpp/pack/buddy/quiet/buddy_quiet2_03.fpk",
            "/Assets/tpp/pack/buddy/quiet/buddy_quiet2_04.fpk", "/Assets/tpp/pack/buddy/quiet/buddy_quiet2_05.fpk",
        };
        ...
        */
        ...
        std::string buddyWalkerGearWeaponFpksDefault[]{
            "/Assets/tpp/pack/buddy/walkergear/bw_wp_00.fpk", "/Assets/tpp/pack/buddy/walkergear/bw_wp_01.fpk",
            "/Assets/tpp/pack/buddy/walkergear/bw_wp_02.fpk", "/Assets/tpp/pack/buddy/walkergear/bw_wp_03.fpk",
        ...
        */
        ...
        ulonglong* GetPathAtBuddyTypeHook(ulonglong param_1, ulonglong* fileSlotIndex, unsigned int buddyType, ulonglong param_4)
        {
            ...
            case 1: // For D-Horse
                if (buddy.horseFpkPath != "")
                    return GetFPKFromFilePath(buddy.horseFpkPath, "horseFpkPath", fileSlotIndex);
                break;
            case 2: // For D-Dog
                if (buddy.dogFpkPath != "")
                    return GetFPKFromFilePath(buddy.dogFpkPath, "dogFpkPath", fileSlotIndex);
                break;
            case 3: // For Quiet
                if (buddy.quietFpkPath != "")
                {
            ...
            case 4: // For Walker Gear
                if (buddy.walkerGearFpkPath != "")
                    return GetFPKFromFilePath(buddy.walkerGearFpkPath, "walkerGearFpkPath", fileSlotIndex);
                break;
