...
struct BuddyEquip
{
    u32 quietWeaponType = 255;
    u32 walkerGearArmType = 255;
    u32 walkerGearHeadType = 255;
    u32 walkerGearWeaponType = 255;
...
{
    buddy.buddyType = (u32)lua_tointeger(L, -1);
...
{
    buddyEqp.quietWeaponType = (u32)lua_tointeger(L, -1);
...
{
    buddyEqp.walkerGearArmType = (u32)lua_tointeger(L, -1);
...
{
    buddyEqp.walkerGearHeadType = (u32)lua_tointeger(L, -1);
...
{
    buddyEqp.walkerGearWeaponType = (u32)lua_tointeger(L, -1);
...
std::string buddyHorsePartsFpksDefault[]{
    "/Assets/tpp/pack/buddy/horse/buddy_horse2_00.fpk", "/Assets/tpp/pack/buddy/horse/buddy_horse2_03.fpk", "/Assets/tpp/pack/buddy/horse/buddy_horse2_02_0.fpk", "/Assets/tpp/pack/buddy/horse/buddy_horse2_02_1.fpk", "/Assets/tpp/pack/buddy/horse/buddy_horse2_02_2.fpk", "/Assets/tpp/pack/buddy/horse/buddy_horse2_05.fpk", "/Assets/tpp/pack/buddy/horse/buddy_horse2_04.fpk",
};
std::string buddyDogPartsFpksDefault[]{
    "/Assets/tpp/pack/buddy/dog/buddy_dog2_00.fpk", "/Assets/tpp/pack/buddy/dog/buddy_dog2_01.fpk", "/Assets/tpp/pack/buddy/dog/buddy_dog2_02.fpk", "/Assets/tpp/pack/buddy/dog/buddy_dog2_03.fpk", "/Assets/tpp/pack/buddy/dog/buddy_dog2_04.fpk",
};
std::string buddyQuietPartsFpksDefault[]{
    "/Assets/tpp/pack/buddy/quiet/buddy_quiet2_00.fpk", "/Assets/tpp/pack/buddy/quiet/buddy_quiet2_01.fpk", "/Assets/tpp/pack/buddy/quiet/buddy_quiet2_02.fpk", "/Assets/tpp/pack/buddy/quiet/buddy_quiet2_03.fpk", "/Assets/tpp/pack/buddy/quiet/buddy_quiet2_04.fpk", "/Assets/tpp/pack/buddy/quiet/buddy_quiet2_05.fpk",
};
...
std::string buddyWalkerGearWeaponFpksDefault[]{
    "/Assets/tpp/pack/buddy/walkergear/bw_wp_00.fpk", "/Assets/tpp/pack/buddy/walkergear/bw_wp_01.fpk", "/Assets/tpp/pack/buddy/walkergear/bw_wp_02.fpk", "/Assets/tpp/pack/buddy/walkergear/bw_wp_03.fpk", "/Assets/tpp/pack/buddy/walkergear/bw_wp_04.fpk",
};

// ZIP: Main buddy FPKs contain head and arm content. These FPKs are empty but
// unsure if they can serve a purpose.
...
u64* LoadBuddyMainFileHook(u64 param_1, u64* fileSlotIndex, int buddyType, u64 param_4)
{
    ...
    else
    {
        ...
        {
            u64* fileSlotIndex_01;
            if (buddyType == 3)
            { // For Quiet
                // ZIP: Quiet's costumeType is set to 0 for the mission "A Quiet
                // Exit" ( missionCode 10260 ) if (vars_02->missionCode ==
                // 10260) {
            ...
            if (buddyType != 4)
            { // If not walker gear nor Quiet.
                // ZIP: ORIG
                // u64 *filePath64_01 = (u64*)LoadFile_03();
...
*/
u64* LoadBuddyQuietWeaponFpkHook(u64 param_1, u64* fileSlotIndex, short param_quietWeaponId)
{
    ...
    u64 filePath64 = PathCode64(filePath.c_str());
    LoadFile(fileSlotIndex, filePath64);

    return fileSlotIndex;
} // LoadBuddyQuietWeaponFpkHook

u64* LoadBuddyWalkerGearWeaponFpkHook(u64 param_1, u64* fileSlotIndex, u64 param_3, u64 param_4)
{
...
// ZIP: Main buddy FPKs contain head and arm content. Leaving this here, just in
// case.
u64* LoadBuddyWalkerGearArmFpkHook(u64 param_1, u64* fileSlotIndex, u64 param_3, u64 param_4)
{
...
u64* LoadBuddyWalkerGearHeadFpkHook(u64 param_1, u64* fileSlotIndex, u64 param_3, u64 param_4)
{
