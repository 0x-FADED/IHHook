...
bool D3D11Hook::hook()
{
    ...
    pDevice = hook::get_address<ID3D11Device**>(hook::get_pattern<uint8_t>("85 C0 0F 88 CB 00 00 00 48 8B", 0xA)); // static ptr to the games D3D11 device

    pDeviceContext = hook::get_address<ID3D11DeviceContext**>(hook::get_pattern<uint8_t>("33 D2 EB 03 8B 53 08", 0xE)); // static ptr to games device context
