...
namespace IHHook
{
    ...
    void TestHooks_Lua(lua_State* L)
    {
        ...
        */
        ...
        // tex cant think of a good test for this right now (but really these tests are more about seeing if the hooked
        // function actually calls/doesn't crash rather than testing the actual lua api correctness)
        ...
        lua_pop(L, 1); //_IHHook_TestTable, doubles as lua_settop test (well it would if we hadn't already used pop before
                       // this point)
