    ...
    , m_original{0}
{
    ...
    // Create the hook. Call create afterwards to prevent race conditions
    // accessing FunctionHook before it leaves its constructor.
...
FunctionHook::~FunctionHook() { remove(); }
