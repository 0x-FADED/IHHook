...
ff_stringid_hash_nFunc* ff_stringid_hash_n;
FoxStrHash32Func* FoxStrHash32;
path_hash_codeFunc* path_hash_code;
FNVHash32Func* FNVHash32;
GetFreeMissionNameKeyFunc* GetFreeMissionNameKey;
UpdateCameraFunc* UpdateCamera;
foxprintfFunc* foxprintf;
l_StubbedOutFunc* l_StubbedOut;
voidreturnFunc* voidreturn;
foxPathPathFunc* foxPathPath;
UpdateLocalPathStringFunc* UpdateLocalPathString;
foxPathPathBFunc* foxPathPathB;
foxPathEmptyFunc* foxPathEmpty;
GetPartsFpkPathFunc* GetPartsFpkPath;
GetPartsFilePathFunc* GetPartsFilePath;
GetCamoFpkPathFunc* GetCamoFpkPath;
GetCamoFilePathFunc* GetCamoFilePath;
GetFacialMtarFpkPathFunc* GetFacialMtarFpkPath;
GetFacialMtarFilePathFunc* GetFacialMtarFilePath;
GetHandFpkPathFunc* GetHandFpkPath;
GetHandFilePathFunc* GetHandFilePath;
_DoesNeedBodyFovaForDDFunc* _DoesNeedBodyFovaForDD;
GetBodyFovaPathFunc* GetBodyFovaPath;
DoesNeedFaceFovaFunc* DoesNeedFaceFova;
DoesNeedFaceFovaForAvatarFunc* DoesNeedFaceFovaForAvatar;
GetFaceFpkPathFunc* GetFaceFpkPath;
GetFaceFilePathFunc* GetFaceFilePath;
GetAvatarHoneFpkPathFunc* GetAvatarHoneFpkPath;
GetAvatarHoneFilePathFunc* GetAvatarHoneFilePath;
GetPathAtBuddyTypeFunc* GetPathAtBuddyType;
GetBuddyQuietWeaponFileFromBuddyBlockFunc* GetBuddyQuietWeaponFileFromBuddyBlock;
GetPathAtSub_BuddyDogFunc* GetPathAtSub_BuddyDog;
GetPathAtSub_BuddyHorseFunc* GetPathAtSub_BuddyHorse;
GetBuddyGearArmFileFunc* GetBuddyGearArmFile;
GetBuddyGearHeadFileFunc* GetBuddyGearHeadFile;
GetBuddyGearMainWeaponFileFunc* GetBuddyGearMainWeaponFile;
FoxBlockLoadFunc* FoxBlockLoad;
ReliefVehicleLoadToExhibitFunc* ReliefVehicleLoadToExhibit;
ReliefVehicleLoadFunc* ReliefVehicleLoad;
GetBlockAtIndexFunc* GetBlockAtIndex;
gkGetColoringSystemFunc* gkGetColoringSystem;
GetBuddyCommandNameFunc* GetBuddyCommandName;
GetBuddyCommandHelpNameFunc* GetBuddyCommandHelpName;
