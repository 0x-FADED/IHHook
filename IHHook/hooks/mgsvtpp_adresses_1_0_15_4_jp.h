...
namespace IHHook
{
    std::unordered_map<std::string, uint64_t> mgsvtpp_adresses_1_0_15_4_jp{
        ...
        //{"foxBlockLoad", 0x1431d96b0},//int * fox::Block::Load(void *thisPtr,int *errorCode,ulonglong *pathID,uint
        // param_4)
