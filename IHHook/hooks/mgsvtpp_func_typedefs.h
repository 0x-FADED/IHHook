...
// Typdefs and externs for the function pointers as well as detour function
// declaration (not func ptrs)
...
typedef u64(__fastcall StrCode64Func)(const char* buf, i64 len);
typedef u64(__fastcall PathCode64Func)(const char* strToHash);
typedef u32(__fastcall FNVHash32Func)(const char* strToHash);
typedef u64*(__fastcall GetFreeRoamLangIdFunc)(u64* langId, short locationCode, short missionCode);
typedef void(__fastcall UpdateFOVLerpFunc)(u64 param_1);
...
typedef void(__fastcall LoadFileSubFunc)(u64 filePath64, u64 filePath64_01);
typedef u64*(__fastcall LoadFileFunc)(u64* fileSlotIndex, u64 filePath64);
typedef u64*(__fastcall LoadFile_01Func)(u64* param_1, u64* param_2);
typedef void(__fastcall LoadFile_02Func)(u64* pathCode64HashPtr);
typedef u64*(__fastcall LoadFile_03Func)();
typedef u64*(__fastcall LoadFile_05Func)(u64* param_1, u64* param_2);
typedef u64*(__fastcall LoadPlayerPartsFpkFunc)(u64* fileSlotIndex, u32 playerType, u32 playerPartsType);
typedef u64*(__fastcall LoadPlayerPartsPartsFunc)(u64* fileSlotIndex, u32 playerType, u32 playerPartsType);
typedef u64*(__fastcall LoadPlayerCamoFpkFunc)(u64* fileSlotIndex, u32 playerType, u32 playerPartsType, u32 playerCamoType);
typedef u64*(__fastcall LoadPlayerCamoFv2Func)(u64* fileSlotIndex, u32 playerType, u32 playerPartsType, u32 playerCamoType);
typedef u64*(__fastcall LoadPlayerFacialMotionFpkFunc)(u64* fileSlotIndex, u32 playerType);
typedef u64*(__fastcall LoadPlayerFacialMotionMtarFunc)(u64* fileSlotIndex, int playerType);
typedef u64*(__fastcall LoadPlayerBionicArmFpkFunc)(u64* fileSlotIndex, u32 playerType, u32 playerPartsType, u32 playerHandType);
typedef u64*(__fastcall LoadPlayerBionicArmFv2Func)(u64* fileSlotIndex, u32 playerType, u32 playerPartsType, u32 playerHandType);
typedef bool(__fastcall CheckPlayerPartsIfShouldApplySkinToneFv2Func)(u32 playerType, u32 playerPartsType);
typedef u64*(__fastcall LoadPlayerPartsSkinToneFv2Func)(u64* loadFile, u32 playerType, u32 playerPartsType);
typedef bool(__fastcall IsHeadNeededForPartsTypeFunc)(u32 playerPartsType);
typedef bool(__fastcall IsHeadNeededForPartsTypeAndAvatarFunc)(u32 playerPartsType);
typedef u64*(__fastcall LoadPlayerSnakeFaceFpkFunc)(u64* fileSlotIndex, u32 playerType, u32 playerPartsType, u32 playerFaceId, char playerFaceEquipId);
typedef u64*(__fastcall LoadPlayerSnakeFaceFv2Func)(u64* fileSlotIndex, u32 playerType, u32 playerPartsType, u32 playerFaceId, char playerFaceEquipId);
typedef u64*(__fastcall LoadAvatarOgreHornFpkFunc)(u64* fileSlotIndex, u32 ogreLevel);
typedef u64*(__fastcall LoadAvatarOgreHornFv2Func)(u64* fileSlotIndex, u32 ogreLevel);
typedef u64*(__fastcall LoadBuddyMainFileFunc)(u64 param_1, u64* fileSlotIndex, u32 buddyType, u64 param_4);
typedef u64*(__fastcall LoadBuddyQuietWeaponFpkFunc)(u64 param_1, u64* fileSlotIndex, short param_quietWeaponId);
typedef u64*(__fastcall LoadBuddyWalkerGearArmFpkFunc)(u64 param_1, u64* fileSlotIndex, u64 param_3, u64 param_4);
typedef u64*(__fastcall LoadBuddyWalkerGearHeadFpkFunc)(u64 param_1, u64* fileSlotIndex, u64 param_3, u64 param_4);
typedef u64*(__fastcall LoadBuddyWalkerGearWeaponFpkFunc)(u64 param_1, u64* fileSlotIndex, u64 param_3, u64 param_4);
typedef int*(__fastcall LoadDefaultFpksFuncFunc)(void* param_1, int* param_2, u64* param_3, u32 param_4);
typedef char(__fastcall PreparePlayerVehicleInSortieFunc)(i64 param_1);
typedef char(__fastcall PreparePlayerVehicleInGameFunc)(i64 param_1, u64 param_2);
typedef i64(__fastcall LoadDefaultFpkPtrFuncFunc)(i64 param_1, u32 param_2);
typedef u64*(__fastcall LoadAllVehicleCamoFpksFunc)();
