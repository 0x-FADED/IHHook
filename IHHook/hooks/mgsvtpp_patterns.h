...
namespace IHHook
{
    std::map<std::string, std::string> mgsvtpp_patterns{
        ...
        //{"UnkSomePrintFunction", ""},//WARNING: UnkSomePrintFunction: Instruction at 142ef2c00 is not adjacent to previous
        //(expected 142ef2c3d)
        //{"l_StubbedOut", ""},//WARNING: l_StubbedOut: Instruction at 14024a8e3 is not adjacent to previous (expected
        // 14024a8f0)
        ...
        { "foxPathEmpty",
          "48 83 ec 38 48 c7 44 24 20 fe ff ff ff 8b ? ? ? ? ? a8 01 ? ? 83 c8 01 89 ? ? ? ? ? ? c0 48 89 ? "
          "? ? ? ? 48 8d 0d" },

        { "GetPartsFpkPath",
          "? 89 4c ? 08 53 ? 83 ec 30 ? c7 44 ? 28 fe ff ff ff ? 89 cb 31 c0 89 44 ? 20 83 fa 04 75 11 ? "
          "ba 95 03 6e 5b f2 e6 2a 52" },
        { "GetPartsFilePath",
          "? 89 4c ? 08 53 ? 83 ec 30 ? c7 44 ? 28 fe ff ff ff ? 89 cb 31 c0 89 44 ? 20 83 fa 04 75 11 "
          "? ba f6 46 0d 90 2a b8 a9 e0" },
        ...
        { "GetPhotoAdditionalTextLangId", "48 89 5c 24 08 48 89 7c 24 ? 55 48 8d 6c 24 ? 48 81 ec ? 01 00 00" },
        ...
        { "lua_isnumber",
          "48 83 EC 38 E8 ? ? ? ? 83 78 ? 03 74 ? 48 8D 54 24 ? 48 89 C1 E8 ? ? ? ? 48 85 C0 75 ? 48 83 C4 "
          "38 C3 B8 01 00 00 00" },
        ...
        { "lua_tointeger",
          "48 83 EC 38 E8 ? ? ? ? 83 78 ? 03 74 ? 48 8D 54 24 ? 48 89 C1 E8 ? ? ? ? 48 85 C0 75 ? 48 83 C4 "
          "38 C3 F2 48 0F 2C 00" },
        { "lua_toboolean", "48 83 EC 28 E8 ? ? ? ? 8B 48 ? 85 C9" },
        { "lua_tolstring",
          "48 89 5C 24 ? 48 89 74 24 ? 57 48 83 EC 20 4C 89 C3 89 D6 48 89 CF E8 ? ? ? ? 49 89 C2 83 78 ? "
          "04 74 ? 48 89 C2 48 89 F9 E8 ? ? ? ? 85 C0 75 ? 48 85 DB" },
        ...
        { "lua_getfield",
          "48 89 5C 24 ? 57 48 83 EC 30 4D 89 C2 48 89 CB E8 ? ? ? ? 48 89 C7 49 83 C8 FF 0F 1F 40 00 49 FF "
          "C0 43 80 3C ? 00 75 ? 4C 89 D2 48 89 D9 E8 ? ? ? ? 4C 8B 4B ? 4C 8D 44 24 ? 48 89 FA" },
        ...
        { "lua_setfield",
          "48 89 5C 24 ? 57 48 83 EC 30 4D 89 C2 48 89 CB E8 ? ? ? ? 48 89 C7 49 83 C8 FF 0F 1F 40 00 49 FF "
          "C0 43 80 3C ? 00 75 ? 4C 89 D2 48 89 D9 E8 ? ? ? ? 4C 8B 4B ? 4C 8D 44 24 ? 49 83 E9 10" },
        ...
        //{"lua_cpcall", ""},//WARNING: lua_cpcall: Instruction at 146c7dd11 is not adjacent to previous (expected
        // 146c7dde0)
        ...
        { "luaL_prepbuffer",
          "57 48 83 EC 20 4C 8B 01 48 89 CF 49 29 C8 49 83 E8 18 74 ? 48 89 5C 24 ? 48 8D 59 ? 48 8B 49 "
          "? 48 89 DA E8 ? ? ? ? FF 47 ? 48 89 F9" },
        ...
        { "luaL_pushresult",
          "57 48 83 EC 20 4C 8B 01 48 89 CF 49 29 C8 49 83 E8 18 74 ? 48 89 5C 24 ? 48 8D 59 ? 48 8B 49 "
          "? 48 89 DA E8 ? ? ? ? FF 47 ? 48 89 1F" },
        { "luaopen_base", "53 48 83 EC 20 48 89 CB E8 ? ? ? ? 4C 8D 05 ? ? ? ? 48 8D 15 ? ? ? ? 48 89 D9 E8 ? ? ? ? B8 02 00 00 00" },
        { "luaopen_table", "48 83 EC 28 4C 8D 05 ? ? ? ? 48 8D 15 ? ? ? ? E8 ? ? ? ? B8 01 00 00 00 48 83 C4 28 C3" }, // WARNING: Could not
                                                                                                                       // find unique Pattern,
                                                                                                                       // found 3 matches
        { "luaopen_io", "48 89 5C 24 ? 48 89 74 24 ? 57 48 83 EC 20 48 8D 15 ? ? ? ?" },
        { "luaopen_os", "48 83 EC 28 4C 8D 05 ? ? ? ? 48 8D 15 ? ? ? ? E8 ? ? ? ? B8 01 00 00 00 48 83 C4 28 C3" }, // WARNING: Could not
                                                                                                                    // find unique Pattern,
                                                                                                                    // found 3 matches
        ...
        { "luaopen_debug", "48 83 EC 28 4C 8D 05 ? ? ? ? 48 8D 15 ? ? ? ? E8 ? ? ? ? B8 01 00 00 00 48 83 C4 28 C3" }, // WARNING: Could not
                                                                                                                       // find unique Pattern,
                                                                                                                       // found 3 matches
